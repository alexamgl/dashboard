...
class UploadDocumentsGiro {
    ...
    public function guardarDocumento($datos) {
        $sql = "CALL InsertarDocumentoGiro(:id_usuario, :carpeta, :public_id, :nombre_documento, :url_documento, @id_documento)";
    ...
    public function obtenerDocumentosPorUsuario($id_usuario) {
        $sql = "SELECT * FROM docs_giro WHERE id_usuario = :id_usuario";
        $stmt = $this->conn->prepare($sql);
    ...
    public function actualizarUsuarioEnDocumento($id_documento, $id_usuario) {
        $sql = "UPDATE docs_giro SET id_usuario = :id_usuario WHERE id_documento = :id_documento";
        $stmt = $this->conn->prepare($sql);
        $stmt->bindParam(':id_usuario', $id_usuario, PDO::PARAM_INT);
    ...
    public function obtenerDocumentosRelacionadosPorUsuario($id_usuario) {
        $sql = "SELECT db.* FROM docs_giro db
