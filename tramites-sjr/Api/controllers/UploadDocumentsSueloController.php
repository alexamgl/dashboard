...
require_once '../models/uploadDocumentsSuelo.php'; // Modelo de base de datos
...
class UploadDocumentsSueloController {
    private $model;
    private $db;
    ...
    public function __construct() {
        ...
        $this->model = new UploadDocumentsSuelo($this->db);
     ...
     */
    public function uploadDocumentsSuelo($data) {
        ...
        try {
            $upload = (new UploadApi())->upload($file['tmp_name'], [
                'folder' => 'suelo_documentos/' . $id_usuario,
            ]);

            $url_documento = $upload['secure_url'];
            $public_id = $upload['public_id'];
            $carpeta = 'suelo_documentos/' . $id_usuario;
