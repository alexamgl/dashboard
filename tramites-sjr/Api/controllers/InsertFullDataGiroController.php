...
class InsertFullDataGiroController {
    private $conn;
    ...
    public function Create($data) {
        ...
        try {
            ...
            $query = "CALL insertar_factibilidad_giro(
                :id_usuario,
                :superficie,
                :claveCatastral,
                :razonSocial,
            ...
            $stmt->bindParam(':arrendatario', $data->arrendatario);
            $stmt->bindParam(':superficieLocal', $data->superficieLocal);
            $stmt->bindParam(':descAct', $data->descAct);
            $stmt->bindParam(':tipoSolicitud', $data->tipoSolicitud);
            $stmt->bindParam(':tipoFactibilidad', $data->tipoFactibilidad);
