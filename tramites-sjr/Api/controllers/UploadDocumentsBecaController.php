...
require_once '../models/uploadDocumentsBeca.php'; // Modelo de base de datos
...
class UploadDocumentsBecaController {
    private $model;
    private $db;
    ...
    public function __construct() {
        ...
        $this->model = new UploadDocumentsBeca($this->db);
     ...
     */
    public function uploadDocumentsBeca($data) {
        ...
        try {
            $upload = (new UploadApi())->upload($file['tmp_name'], [
                'folder' => 'becas_documentos/' . $id_usuario,
            ]);

            $url_documento = $upload['secure_url'];
            $public_id = $upload['public_id'];
            $carpeta = 'becas_documentos/' . $id_usuario;
